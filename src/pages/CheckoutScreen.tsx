  ...
  return (
    <div className="w-full h-full bg-bg-black flex flex-col overflow-hidden">
      ...
      <div className="flex items-center justify-between px-8 py-4 border-b border-white/10">
        ...
        <h1 className="text-white font-bold text-xl">סיום הזמנה</h1>
      ...
      <div className="flex-1 overflow-hidden flex gap-0">
        ...
        <div className="flex-1 overflow-y-auto p-8">
          <h2 className="text-white font-bold text-lg mb-4">סיכום הזמנה</h2>
        ...
        <div className="w-80 border-r border-white/10 p-8 flex flex-col gap-6">
          ...
          {/* Notes */}
          <div className="bg-bg-card rounded-2xl p-5">
            <h3 className="text-white font-bold mb-3 text-right">הערות</h3>
            <textarea
              value={notes}
              onChange={e => setNotes(e.target.value)}
              placeholder="בלי בצל, אלרגיה לבוטנים, רוטב בצד..."
          ...
          <div className="bg-bg-card rounded-2xl p-5">
            <div className="flex justify-between items-center">
              <span className="text-dark-red font-black text-3xl">₪{cartTotal}</span>
