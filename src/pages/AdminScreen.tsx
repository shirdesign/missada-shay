...
export default function AdminScreen({ onClose }: Props) {
  ...
  const totalCoins = orders.reduce((s, o) => s + o.total, 0)

  const filtered = orders.filter(o =>
    String(o.id).includes(search) || String(o.tableNumber).includes(search) || o.status.includes(search)
  )
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-8 py-4 border-b border-white/10">
        ...
        <div className="text-white/50 text-sm">ניהול</div>
      </div>
